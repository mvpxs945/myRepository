...
export default {
    ...
    methods:{
        goBack(){
            cmd.dataReport('KH_0xED_0001686A','event','back_weex','moreFunction',this.deviceSn,{});//埋点
            nativeService.goBack()
        },
        goWaterCount(){
            cmd.dataReport('KH_0xED_0001686A','event','go_waterCount','moreFunction',this.deviceSn,{});//埋
            nativeService.goTo('waterCount.js')
        },
        goFilterLife(index){
            cmd.dataReport('KH_0xED_0001686A','event','go_filterLife','moreFunction',this.deviceSn,{});//埋
            nativeService.setItem("key",index);
            nativeService.goTo('filterLife.js')
        },
        goChangeFilter(){
            cmd.dataReport('KH_0xED_0001686A','event','go_buyFilter','moreFunction',this.deviceSn,{});//埋
        ...
        goFilterHelp(){
            cmd.dataReport('KH_0xED_0001686A','event','go_operate','moreFunction',this.deviceSn,{});//埋
            nativeService.goTo('filterHelp.js')
        },
    },
    created() {
