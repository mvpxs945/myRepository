...
export default {
    ...
    methods:{
        ...
        tabClicked(index){
            ...
            switch(index){
                case 0:
                cmd.dataReport('KH_0xED_0001686A','event','go_week','waterCount',this.deviceSn,{});//埋点
                ...
                break;
                case 1:
                cmd.dataReport('KH_0xED_0001686A','event','go_month','waterCount',this.deviceSn,{});//埋点
                ...
                break;
                case 2:
                cmd.dataReport('KH_0xED_0001686A','event','go_year','waterCount',this.deviceSn,{});//埋点
    ...
    created() {
        ...
        nativeService.getItem("device_sn",function(sn){
            ...
            cmd.dataReport('KH_0xED_0001686A','view','page_view','waterCount',self.deviceSn,{});//埋点
        })
