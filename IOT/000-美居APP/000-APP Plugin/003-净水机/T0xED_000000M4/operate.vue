<template>
    <div class="knowSmartSetting" :style="objClass">
        ...
        <div class="knowSmartSettingWrapper" :style="wrapper">
            <web src="http://mp.weixin.qq.com/s?__biz=MzAwODYxMzA2Mw==&mid=502878321&idx=1&sn=dcdb537fa7e820f607a10e570a131ab8&scene=0#wechat_redirect" style="width:750px;" :style="wrapper"></web>
        </div>
    </div>
</template>
<script>
