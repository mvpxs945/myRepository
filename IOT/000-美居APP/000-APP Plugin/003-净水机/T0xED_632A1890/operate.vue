<template>
    <div class="knowSmartSetting" :style="objClass">
        ...
        <div class="knowSmartSettingWrapper" :style="wrapper">
            <web src="http://handbook.midea-hotwater.com:13145/data/ED/1890/index.html" style="width:750px;" :style="wrapper"></web>
        </div>
    </div>
</template>
<script>
...
export default {
    ...
    created() {
       ...
       nativeService.getItem("device_sn",function(sn){
            ...
            // cmd.dataReport('KH_0xED_63202008','view','page_view','operate',self.deviceSn,{});//埋点
        })
