<template>
    <div class="wrapper" :style="objClass">
        <div class="first-up" :style="upClass">
            <midea-header :title="'净水机'" :titleText="'#ffffff'" :isImmersion="true" :showRightImg="true" :showLeftImg="true" @leftImgClick="goBack" @rightImgClick="goMore"></midea-header>
            ...
            <div class="first-up-bottom">
                <div class="bottom-wrapper">
                    <text class="bottom-life">{{filterList[0].text}}%</text>
                    <text class="bottom-text">RO</text>
                </div>
                <div class="bottom-wrapper">
                    <text class="bottom-life">{{filterList[1].text}}%</text>
                    <text class="bottom-text">PCB</text>
                </div>
            </div>
...
export default {
    ...
    methods: {
        goMore(){
            cmd.dataReport('KH_0xED_6321782D','event','go_moreFunction','weex',this.deviceSn,{});//埋点
    ...
    created() {
        ...
        nativeService.getDeviceInfo().then((res)=>{
            ...
            cmd.dataReport('KH_0xED_6321782D','view','page_view','weex',res.result.deviceSn,{});//埋点
            //保存当前设备状态到公共状态
            nativeService.startCmdProcess("query",cmd.createQueryMessage(),function(res){
                if(typeof res=='string'){
                    var msg=JSON.parse(res);
                ...
                if(parseInt(msg[26],10)<=5||parseInt(msg[27],10)<=5){
                    if(parseInt(msg[26],10)==0||parseInt(msg[27],10)==0){
