...
export default {
    ...
    methods:{
        goBack(){
            cmd.dataReport('KH_0xED_6321782D','event','back_weex','moreFunction',this.deviceSn,{});//埋点
            nativeService.goBack()
        },
        goWaterCount(){
            cmd.dataReport('KH_0xED_6321782D','event','go_waterCount','moreFunction',this.deviceSn,{});//埋点
            nativeService.goTo('waterCount.js')
        },
        goFilterLife(index){
            cmd.dataReport('KH_0xED_6321782D','event','go_filterLife','moreFunction',this.deviceSn,{});//埋点
            nativeService.setItem("key",index);
            nativeService.goTo('filterLife.js')
        },
        goOperate(){
            cmd.dataReport('KH_0xED_6321782D','event','go_operate','moreFunction',this.deviceSn,{});//埋点
            nativeService.goTo('operate.js')
        },
        goBuy(){
            cmd.dataReport('KH_0xED_6321782D','event','go_buyFilter','moreFunction',this.deviceSn,{});//埋点
