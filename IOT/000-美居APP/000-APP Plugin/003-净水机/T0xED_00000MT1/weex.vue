    ...
    created() {
        ...
        nativeService.getDeviceInfo().then((res)=>{
            ...
            nativeService.startCmdProcess("query",cmd.createQueryMessage(),function(res){
                ...
                filterSwitch(parseInt(msg[37],10)+parseInt(msg[38],10)*256,8460,2);
                filterSwitch(parseInt(msg[39],10)+parseInt(msg[40],10)*256,16920,3);
                filterSwitch(parseInt(msg[41],10)+parseInt(msg[42],10)*256,8460,4);
