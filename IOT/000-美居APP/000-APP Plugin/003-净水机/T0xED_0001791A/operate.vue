<template>
    <div class="knowSmartSetting" :style="objClass">
        ...
        <div class="knowSmartSettingWrapper" :style="wrapper">
            <web src="http://www.midea-weixin.com/webmanual/1791A/manual.html" style="width:750px;" :style="wrapper"></web>
        </div>
    </div>
</template>
<script>
...
export default {
    ...
    created() {
       ...
       nativeService.getItem("device_sn",function(sn){
            ...
            cmd.dataReport('KH_0xED_0001791A','view','page_view','operate',self.deviceSn,{});//埋点
        })
