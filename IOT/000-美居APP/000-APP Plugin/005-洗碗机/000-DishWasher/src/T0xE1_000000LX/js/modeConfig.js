export default{
    ...
    MODE_INTENSIVE:{
      ...
      additionalMode: 0,
      additionalArr:[
        {additionalMode:0,time:125,temp:72,title:'不附加',dec:'',isActive:false},
        {additionalMode:7,time:103,temp:72,title:'少量',dec:'餐具较少的情况下，叠加少量可以省水省电',isActive:false},
      ],
      time: 125,
      temp: 72,
      isDiyMode: false,
    ...
    MODE_NORMAL:{
      ...
      additionalMode: 0,
      additionalArr:[
        {additionalMode:0,time:98,temp:70,title:'不附加',dec:'',isActive:false},
        {additionalMode:7,time:82,temp:70,title:'少量',dec:'餐具较少的情况下，叠加少量可以省水省电',isActive:false},
      ],
      time: 98,
      temp: 70,
      isDiyMode: false,
    ...
    MODE_ECO:{
      ...
      additionalMode: 0,
      additionalArr:[
        {additionalMode:0,time:179,temp:70,title:'不附加',dec:'',isActive:false},
        {additionalMode:7,time:141,temp:65,title:'少量',dec:'餐具较少的情况下，叠加少量可以省水省电',isActive:false},
      ],
      time: 179,
      temp: 70,
      isDiyMode: false,
    ...
    MODE_GLASS:{
      ...
      additionalMode: 0,
      additionalArr:[
        {additionalMode:0,time:72,temp:62,title:'不附加',dec:'',isActive:false},
        {additionalMode:7,time:64,temp:62,title:'少量',dec:'餐具较少的情况下，叠加少量可以省水省电',isActive:false},
      ],
      time: 72,
      temp: 62,
      isDiyMode: false,
    ...
    MODE_RAPID:{
      ...
      additionalArr:[
        ...
        {additionalMode:7,time:24,temp:55,title:'少量',dec:'餐具较少的情况下，叠加少量可以省水省电',isActive:false},
      ],
      time: 29,
      temp: 55,
      isDiyMode: false,
