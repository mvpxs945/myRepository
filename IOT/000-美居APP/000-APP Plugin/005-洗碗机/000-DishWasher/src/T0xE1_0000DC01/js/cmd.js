...
var statusObj = {
  boxUp:{
    ...
    program:{
      ...
      viewArr:["空档","智能洗","强力洗","即时洗","节能洗","玻璃洗","1小时洗","超快洗","预冲洗","90分钟洗","自清洁","水果洗","自定义洗"]
    },
    functionOptions:{
    ...
    displaySign:{
      ...
      detail:{
          ...
          drySwitch:{name:"干燥",value:0x00,view:{0:"打开",1:"关闭"}},
          waterOut:{name:"排水",value:0x00,view:{0:"干燥无须排水",1:"强制关机后排水约20秒"}},
      }
    },
...
export default {
  ...
  cmdDryingSet:function(value){
    ...
    var messageBody = message.createMessageBody(15);
    message.setByte(messageBody,0,0x81);
    message.setByte(messageBody,4,keep);
  ...
  //设置自定义洗涤
  washToNextStep: function(){
    var messageBody = message.createMessageBody(1);
    message.setByte(messageBody,0,0xFF);
    var sendMessage = message.createMessage(0xE1,0x02,messageBody);
    return sendMessage;
  },
  ...
  if((cmdType ==2 || cmdType ==3 || cmdType ==4)){
    ...
    obj.displaySign.detail.drySwitch.value = parseInt(byte14Str[7-0]); 
    obj.displaySign.detail.waterOut.value = parseInt(byte14Str[7-1]); 
    ...
    obj.displaySign.detail.noWater.value = parseInt(byte15Str[7-7]);  
