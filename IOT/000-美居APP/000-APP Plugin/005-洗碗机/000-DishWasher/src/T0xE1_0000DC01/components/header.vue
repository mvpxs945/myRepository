<template>
    <div class="wrapper" style="width:750px;">
        <div :style="headerStyleObj" class="box">
            ...
            <div class="header-right-wrapper" @click="headerClick('rightImgClick')">
                <image v-if="rightImg && rightImg !=''" class="header-right-image" :src="rightImg"/>
            </div>
        ...
        <div v-if="rightText && rightText !=''" class="header-left-wrapper" @click="headerClick('rightTextClick')">
                <text class="header-right-text" :style="{color:rightColor|titleColor, fontSize:fontSize+'px'}">{{rightText}}</text>
        </div>
    </div>
</template>
