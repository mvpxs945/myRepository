...
var statusObj = {
  boxUp:{
    ...
    program:{
      name:"程序",value:0x00,
      // view:{0:"空档",1:"智能洗",2:"强力洗",3:"即时洗",4:"节能洗",5:"玻璃洗",6:"1小时洗",7:"超快洗",8:"预冲洗",9:"90分钟洗",10:"自清洁洗",11:"水果洗",12： "自定义洗",15："紫外除菌"},
      viewArr: ["空档", "智能洗", "强力洗", "即时洗", "节能洗", "玻璃洗", "1小时洗", "超快洗", "预冲洗", "90分钟洗", "自清洁", "水果洗", "自定义洗", "","","紫外除菌"]
    },
    functionOptions:{
...
export default {
  ...
  analysisCmd: function(requestCmd) {
    // nativeService.alert('收到串口指令：'+requestCmd);
  ...
  if((cmdType ==2 || cmdType ==3 || cmdType ==4)){
    ...
    obj.totalMinutes.value = parseInt(requestCmd[39]); 
   }
