export default{
    ...
    MODE_INTENSIVE:{
      ...
      additionalMode: 0,
      additionalArr:[
        {additionalMode:0,time:112,temp:70,title:'不附加',dec:'',isActive:false},
        {additionalMode:3,time:92,temp:70,title:'加速',dec:'轻度油污餐具，加速可以加快洗涤进度',isActive:false},
      ],
      time: 112,
      temp: 70,
      isDiyMode: false,
    ...
    MODE_ECO:{
      ...
      additionalArr:[
        {additionalMode:0,time:165,temp:65,title:'不附加',dec:'',isActive:false},
        {additionalMode:3,time:135,temp:68,title:'加速',dec:'轻度油污餐具，加速可以加快洗涤进度',isActive:false},
      ],
      time: 165,
      temp: 65,
      isDiyMode: false,
    ...
    MODE_GLASS:{
      ...
      additionalMode: 0,
      additionalArr:[
        {additionalMode:0,time:67,temp:60,title:'不附加',dec:'',isActive:false},
        {additionalMode:3,time:55,temp:60,title:'加速',dec:'轻度油污餐具，加速可以加快洗涤进度',isActive:false},
      ],
      time: 67,
      temp: 60,
      isDiyMode: false,
    ...
    MODE_DIY:{
      ...
      stageStep:[{name:'预洗',value:1}],
      diyProgram:[
        {name:'DIY1',mainTemp:0, washTemp:0,mainTempRange:[45],washTempRange:[50],stageStep:[{name:'预洗',value:1}]},
        {name:'DIY2',mainTemp:0, washTemp:0,mainTempRange:[45],washTempRange:[50],stageStep:[{name:'预洗',value:1}]},
