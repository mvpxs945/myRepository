  ...
  <div class="container">
    <div class="section_up">
      <div class="gear_up flex_column_center">
        ...
        <text class="text_gear">{{gearText}}</text>
      </div>
...
import cmdFun from "./js/dualCmd.js"; //解析指令
...
export default {
  ...
  methods: {
    ...
    queryStatus: function() {
      var self = this;
      var cmd = cmdFun.createQueryMessage("TYPE_BOX_UP");
  ...
  computed:{
    gearText:function(){
      var self = this;
      var text = '';
      if(self.curGear == 0x01){
        text = '软水盐1档适用水质： 水硬度范围0-90ppm';
      }else if(self.curGear == 0x02){
        text = '软水盐2档适用水质： 水硬度范围91-200ppm';
      }else if(self.curGear == 0x03){
        text = '软水盐3档适用水质： 水硬度范围201-300ppm';
      }else if(self.curGear == 0x04){
        text = '软水盐4档适用水质： 水硬度范围301-400ppm';
      }else if(self.curGear == 0x05){
        text = '软水盐5档适用水质： 水硬度范围401-600ppm';
      }else if(self.curGear == 0x06){
        text = '软水盐6档适用水质： 水硬度范围600ppm以上';
      }
      return text;
    }
  },
