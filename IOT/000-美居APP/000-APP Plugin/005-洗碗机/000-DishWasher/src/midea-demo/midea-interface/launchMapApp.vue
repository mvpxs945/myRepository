<template>
    <div class="wrapper">
        <midea-header title="launchMapApp打开地图软件" :isImmersion="isImmersion" @leftImgClick="back" :showRightImg="true" rightImg="../assets/img/smart_ic_reline@3x.png" @rightImgClick="reload"></midea-header>
