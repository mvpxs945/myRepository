export default{
    ...
    MODE_INTENSIVE:{
      ...
      additionalMode: 0,
      additionalArr:[
        {additionalMode:0,time:89,temp:70,title:'不附加',dec:'',isActive:false},
        {additionalMode:1,time:99,temp:70,title:'加强',dec:'更加干燥清爽',isActive:false},
      ],
      time: 89,
      temp: 70,
      isDiyMode: false,
    ...
    MODE_NORMAL:{
      ...
      additionalMode: 0,
      additionalArr:[
        {additionalMode:0,time:58,temp:65,title:'不附加',dec:'',isActive:false},
        {additionalMode:1,time:68,temp:65,title:'加强',dec:'更加干燥清爽',isActive:false},
      ],
      time: 58,
      temp: 65,
      isDiyMode: false,
    ...
    MODE_ECO:{
      ...
      additionalArr:[
        {additionalMode:0,time:160,temp:72,title:'不附加',dec:'',isActive:false},
        {additionalMode:1,time:170,temp:72,title:'加强',dec:'更加干燥清爽',isActive:false},
      ],
      time: 160,
      temp: 72,
      isDiyMode: false,
    ...
    MODE_GLASS:{
      ...
      additionalMode: 0,
      additionalArr:[
        {additionalMode:0,time:47,temp:75,title:'不附加',dec:'',isActive:false},
        {additionalMode:1,time:65,temp:72,title:'加强',dec:'更加干燥清爽',isActive:false},
      ],
      time: 47,
      temp: 75,
      isDiyMode: false,
    ...
    MODE_TOYWASH:{
      ...
      additionalMode: 0,
      additionalArr:[
        {additionalMode:0,time:29,temp:55,title:'不附加',dec:'',isActive:false},
        {additionalMode:1,time:39,temp:55,title:'加强',dec:'更加干燥清爽',isActive:false},
      ],
      time: 29,
      temp: 55,
      isDiyMode: false,
    ...
    MODE_RAPID:{
      ...
      additionalMode: 0,
      additionalArr:[
        {additionalMode:0,time:29,temp:60,title:'不附加',dec:'',isActive:false},
        {additionalMode:1,time:39,temp:60,title:'加强',dec:'更加干燥清爽',isActive:false},
      ],
      time: 29,
      temp: 60,
      isDiyMode: false,
