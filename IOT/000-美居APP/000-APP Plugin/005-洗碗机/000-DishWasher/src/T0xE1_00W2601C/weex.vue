      ...
      <div class="container">
        <div v-if="curStatus=='standby'" :style="{'padding-bottom':(isipx?ipxBottom+'px':'0px')}" key="standby">
          ...
          <div class="standby-footer" :style="{'height':(isipx?((screenH*0.3 + 98 + ipxBottom) +'px'):((screenH*0.3 + 98) +'px'))}">
            ...
            <div>
            <midea-cell title="保管" :desc="keepDesc" height="120"  @mideaCellClick="btnClick('')">
                <div slot="value">
            ...
            <midea-img-btn v-if="false" class="btn-img border-top" text="预约" :img="icon.btnOrder" @Clicked="btnClick('btn_order')"></midea-img-btn>
            <midea-img-btn :width="750" class="btn-img border-top" text="启动" :img="icon.btnStart" @Clicked="btnClick('btn_start')"></midea-img-btn>
            </div>
          </div>
        </div>
