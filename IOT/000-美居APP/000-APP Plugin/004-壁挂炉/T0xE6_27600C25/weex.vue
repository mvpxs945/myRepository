<template>
    <div class="wrapper" :style="{'height':objHeight}" >
        ...
        <div class="down" :style="{'height':downHeight}">
            <div :style="{'marginTop': (modeFlag == 0) ? '52px' : '112px'}">
            ...
            if(self.status.powerFlag==1){
                ...
                if(self.status.summerMode==0){
                    ...
                    if(self.status.homeMode==0){
                        self.heatNavList[2].img="./assets/img/at_home_off2x.png";
                    }else if(self.status.homeMode==1){
                        self.heatNavList[2].img="./assets/img/at_home_on2x.png";
                    }
                    if(self.status.sleepMode==0){
                        self.heatNavList[3].img="./assets/img/sleep_off2x.png";
                    }else if(self.status.sleepMode==1){
                        self.heatNavList[3].img="./assets/img/sleep_on2x.png";
                    }
                }else{
                    self.heatNavList[1].img="./assets/img/out_off2x.png";
                    self.heatNavList[2].img="./assets/img/at_home_off2x.png";
                ...
                if(self.status.temperatureSensationSwitch==0){
                    self.bathNavList[1].img="./assets/img/shower_off2x.png";
                }else if(self.status.temperatureSensationSwitch==1){
                    self.bathNavList[1].img="./assets/img/shower_on2x.png";
                }
                self.bathNavList[2].img="./assets/img/exclusive_off2x.png";
                    ...
                    if(self.status.summerMode==0){//点击采暖中的模式
                        if(index==0){
                            ...
                            if(self.status.outMode==0){
                                ...
                                self.dialogContent="您确定要切换到智能外出模式吗?"
                                self.modeShow=true;
                            }
                        }else if(index==2){
                            self.modeIndex=2;
